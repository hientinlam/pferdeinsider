...
$table = $installer->getConnection()
    ...
    ->newTable($installer->getTable('brst_comment/comment'))
    ...
    ->addColumn('comment', Varien_Db_Ddl_Table::TYPE_CLOB, 0, array(
            'nullable'  => false,
            ), 'comment')
    ->addColumn('posted_date', Varien_Db_Ddl_Table::TYPE_CLOB, 0, array(
            'nullable'  => false,
            ), 'posted_date');
