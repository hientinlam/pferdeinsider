     ...
     public function createPostAction()
         ...
         if ($this->getRequest()->isPost()) {
              ...
              */
              ...
              if ($this->getRequest()->getParam('is_member')) {
        ...
        /*     if ($this->getRequest()->getPost('create_address')) {
             ...
             try {
                 ...
                 if (true === $validationResult) {
                     ...
                     // echo "<pre>";print_r($arrData);die('dasjhd');
                      ...
                      if($arrData['is_affialiate'])
                      {
                          ...
                          $affialiate_model=Mage::getModel('brst_requestaffialiate/affialiate');
       ...
       if($group_id=='4')
                 ...
                 {
                    $this->_getSession()->setinvalidemail('User with this emailid already exists');
                 $this->_redirectError(Mage::getUrl('register/index/', array('_secure' => true)));
                 }
    }
