        ...
        if ($this->_isValidForCreation()) {
            ...
            foreach($ids as $key=>$id)
            {
              ...
              // die('dsjk');
               ...
               $affiliatepay=($product_price-$adminshareratiovalue)*$affiliateratio/100;
                        ...
                        if($businesstype=='small')
                         {
                             ...
                             $taxratio='0';
                             /***Earnings of Expert **/
                             $expertearning=($product_price-$affiliatepay)*$expertratio/100;
