...
class AW_Affiliate_Adminhtml_AffiliateController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('aW_affiliate_block_adminhtml_affiliate_grid');
    ...
    public function exportExcelAction()
    {
        ...
        $grid       = $this->getLayout()->createBlock('aW_affiliate_block_adminhtml_affiliate_grid');
