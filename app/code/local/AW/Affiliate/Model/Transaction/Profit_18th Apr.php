        ...
        if ($this->_isValidForCreation()) {
            ...
            foreach($ids as $key=>$id)
            {
                ...
                if($ifexist==1)
                {
                    ...
                    $model->setamount_earned($member_amount + $expert_price);
                    //$model->settax_paid($totalamount + $expert_price);
                    $model->setadmin_amount($admin_amount + $admin_price);
                    //$model->setbalance($totalamount + $expert_price);
                    $model->save();
                }
                else
                {
                    ...
                    $model->setamount_earned($expert_price);
