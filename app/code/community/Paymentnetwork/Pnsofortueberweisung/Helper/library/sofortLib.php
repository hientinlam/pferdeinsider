 ...
 *
 * $Date: 2012-04-18 09:37:02 +0200 (Mi, 18. Apr 2012) $
 * @version SofortLib 1.5.0  $Id: sofortLib.php 3844 2012-04-18 07:37:02Z dehn $
	...
	function _indexedArrayToXml($data, $name) {
		...
		if(is_array($data) && count($data) > 0) {
			...
			foreach($data as $value) {
				$msg .= '<'.$name.'>'.$this->_escapeXML($value).'</'.$name.'>'."\n";
			}
			$msg .= '</'.$name."s>\n";
		}
		return $msg;
