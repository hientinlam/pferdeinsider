 ...
 */
class Belvg_Userprofile_Block_Adminhtml_Messages_Reply extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('save_button',
                $this->getLayout()->createBlock('adminhtml/widget_button')
                    ->setData(array(
                        'label'     => Mage::helper('catalog')->__('Send'),
    ...
    {
        return $this->getUrl('*/*/send', array('_current'=>true));
    }
